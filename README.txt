...
which block to place a new requested memory block:
  ...
  4) Next-fit: select the first suitable block after
     the prev block allocated (with wraparound
...
https://docs.google.com/spreadsheets/d/1Gv5-10nQ5JLLKMJ7haUexwChu5SIStjg/edit#gid=1040591361 
...
You will have to peer review the other three strategies out of: 
first-fit
worst-fit
best-fit
next-fit.  
You should in  a group that will be assigned to you should sit together to combine your solution 
and make the 10 questions asked below.
